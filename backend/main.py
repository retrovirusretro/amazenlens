...
app.add_middleware(
    ...
    # Her Vercel preview deploy'u farklı subdomain alıyor — regex ile hepsini kapsa
    allow_origin_regex=r"https://amazenlens-[a-z0-9]+-retrovirusretros-projects\.vercel\.app",
...
from routers import demand, rank

...
const sortData = (data, key, dir) => {
  return [...data].sort((a, b) => {
    const mockA = getMockData(a.asin), mockB = getMockData(b.asin)
    const getVal = (p, mock) => {
    ...
    const valA = getVal(a, mockA), valB = getVal(b, mockB)
            ...
            {filtered.map((product) => {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ display: 'flex', justifyContent: 'center' }}><MiniChart points={mock.points} color="#0071e3" /></div>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    ...
                    <div style={{ fontSize: '10px', color: '#8e8e93' }}>👥 {sellers} {t('search.sellers')}</div>
                  </div>

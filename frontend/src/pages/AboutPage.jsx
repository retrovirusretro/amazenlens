...
const MILESTONES = [
  ...
  { year: 'Q1 2025', label: 'Geliştirme', desc: 'Faz 1 özellikleri, MVP ve backend altyapısı kuruldu' },
  { year: 'Q2 2025', label: 'ITÜ Çekirdek', desc: 'ITÜ Çekirdek Girişim programına kabul — kuluçka desteği başladı' },
  { year: 'Q1 2026', label: '🚀 Canlı!', desc: 'amazenlens.com Vercel\'de yayında, Railway backend aktif, 5 dil desteği' },
  { year: '2026 ↗', label: 'Büyüme', desc: 'TÜBİTAK BiGG (900K TL), KOSGEB (375K TL), EIC Accelerator (€2.5M) başvuruları' },
]
...
export default function AboutPage() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', -apple-system, sans-serif", maxWidth: '960px', color: '#1d1d1f' }}>
      <Helmet>
        <title>Hakkımızda — AmazenLens | Amazon Araştırma Platformu</title>
        <meta name="description" content="AmazenLens, Amazon satıcıları için Helium 10'un 1/5 fiyatına akademik temelli AI araştırma platformu. ITÜ Çekirdek destekli, 5 dil, küresel ölçek." />
        <meta property="og:title" content="Hakkımızda — AmazenLens" />
        <meta property="og:description" content="Amazon araştırmasını demokratikleştiriyoruz. Claude AI, 5 dil, global Amazon pazarları." />
        <link rel="canonical" href="https://amazenlens.com/app/about" />
      </Helmet>
      <style>{`
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: '12px', marginBottom: '16px' }}>
        <div className="about-card" style={{ background: 'white', borderRadius: '14px', border: '0.5px solid #e5e5ea', padding: '24px', animationDelay: '0.1s' }}>
          <div style={{ fontSize: '11px', color: '#0071e3', fontWeight: '600', letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '10px' }}>{t('about.mission_label')}</div>
        ...
        <div className="about-card" style={{ background: 'white', borderRadius: '14px', border: '0.5px solid #e5e5ea', padding: '24px', animationDelay: '0.15s' }}>
          <div style={{ fontSize: '11px', color: '#34c759', fontWeight: '600', letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '10px' }}>{t('about.contact_label')}</div>
          <div style={{ fontSize: '16px', fontWeight: '600', color: '#1d1d1f', marginBottom: '16px' }}>{t('about.contact_title')}</div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            {[
              { icon: '✉️', label: t('about.contact_support'), value: 'support@amazenlens.com', href: 'mailto:support@amazenlens.com' },
              { icon: '🌐', label: t('about.contact_website'), value: 'amazenlens.com', href: 'https://amazenlens.com' },
              { icon: '🎓', label: t('about.contact_incubator'), value: 'ITÜ Çekirdek Girişim Programı', href: null },
            ].map(item => (
          ...
          <div style={{ marginTop: '16px', padding: '12px', background: '#f0fff4', borderRadius: '10px', border: '0.5px solid #b7f0c8' }}>
            ...
            <div style={{ fontSize: '11px', color: '#8e8e93', marginTop: '3px' }}>{t('about.feedback_response')}</div>
          </div>
        </div>
      </div>
      ...
      <div className="about-card" style={{ background: 'white', borderRadius: '14px', border: '0.5px solid #e5e5ea', padding: '24px', marginBottom: '16px', animationDelay: '0.2s' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
          <div>
            <div style={{ fontSize: '11px', color: '#ff9f0a', fontWeight: '600', letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '6px' }}>{t('about.algorithms_label')}</div>
            <div style={{ fontSize: '17px', fontWeight: '600', color: '#1d1d1f', letterSpacing: '-0.3px' }}>
              {t('about.algorithms_title')}
            </div>
          </div>
          <div style={{ fontSize: '12px', padding: '6px 14px', borderRadius: '20px', background: '#fff4e0', color: '#b45309', fontWeight: '500' }}>
            {t('about.algorithms_count')}
          </div>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '16px' }}>
        <div className="about-card" style={{ background: 'white', borderRadius: '14px', border: '0.5px solid #e5e5ea', padding: '24px', animationDelay: '0.55s' }}>
          <div style={{ fontSize: '11px', color: '#af52de', fontWeight: '600', letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '14px' }}>{t('about.team_label')}</div>
          {TEAM.map(member => (
          ...
          <div style={{ marginTop: '16px', padding: '12px 14px', background: '#f5f5f7', borderRadius: '10px' }}>
            ...
            <div style={{ fontSize: '11px', color: '#8e8e93' }}>{t('about.itu_desc')}</div>
          </div>
        </div>
        ...
        <div className="about-card" style={{ background: 'white', borderRadius: '14px', border: '0.5px solid #e5e5ea', padding: '24px', animationDelay: '0.6s' }}>
          <div style={{ fontSize: '11px', color: '#0071e3', fontWeight: '600', letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '14px' }}>{t('about.journey_label')}</div>
      ...
      <div className="about-card" style={{ background: 'white', borderRadius: '14px', border: '0.5px solid #e5e5ea', padding: '24px', marginBottom: '16px', animationDelay: '0.65s' }}>
        <div style={{ fontSize: '11px', color: '#34c759', fontWeight: '600', letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '14px' }}>{t('about.competitor_label')}</div>
